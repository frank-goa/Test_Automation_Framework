...
- Create AccountRegistrationTest class under "testsCases" package which will contain the test case for account
  registration.
...
- Update the HomePage class to include the locator for Login link and a method for navigating to the login page.
- Create a new page object class named "LoginPage" under the pageObjects package.
    - This class will contain the locators and methods for the login page.
    - Add locators for the following elements:
        - Email input field
        - Password input field
        - Login button
        - Add a method to perform login action using the email and password.
- Create a new page object class named "MyAccountPage" under the pageObjects package.
    - This class will contain the constructor, locators and methods for the My Account page.
    - Add locators for the following elements:
        - My Account heading
        - Logout link
    - Add a method to verify if the user is logged in by checking if the 'My Account' heading is displayed.
- Create a new test case class named "TC002_LoginTest" under the testCases package.
    - This class will contain the test case for login functionality.
    - Add a method to perform login using the LoginPage class and verify if the user is logged in by checking the My
      Account page.

- Update the master.xml file to include the new test case class.
